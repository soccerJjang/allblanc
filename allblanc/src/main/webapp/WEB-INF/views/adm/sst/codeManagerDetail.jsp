...
<tr>
	<th scope="row">코드</th>
	<td>
		<input type="text" id="code" name="code" class="form-control col-md-11" maxlength="10" placeholder="코드를 입력하세요." value="${resultInfo.code}">
		<label for="coderNm"class="no-mrg-btm mrg-top-10">※ 최대 10자까지 입력하세요.</label>
	</td>
</tr>
<tr>
	<th scope="row">코드명</th>
	<td>
		<input type="text" id="codeNm" name="codeNm" class="form-control col-md-11" maxlength="60" placeholder="코드명을 입력하세요." value="${resultInfo.codeNm}">
		<label for="coderNm"class="no-mrg-btm mrg-top-10">※ 최대 60자까지 입력하세요.</label>
	</td>
</tr>
<tr>
	<th scope="row">코드설명</th>
	<td>
		<input type="text" id="codeDc" name="codeDc" class="form-control col-md-11" maxlength="200" placeholder="코드설명을 입력하세요." value="${resultInfo.codeDc}">
